...
//        alert(ext);
        window.location = ext + "link?location=Logout";
    } else {
//        alert("userid = "+userid);
...
function Accordion() {
    ...
    $("<i />", {class: "fa fa-fw fa-chevron-up ac-add half-marginright smalltext arrow-up"}).prependTo(".accordion-handler").hide();
    $("<i />", {class: "fa fa-fw fa-chevron-down ac-add half-marginright smalltext arrow-down"}).prependTo(".accordion-handler");
    ...
    $(".accordion-handler").unbind("click").click(function () {
        $(this).closest(".accordion-parent").find(".accordion-content").slideToggle(500);
        $(this).find(".arrow-up").toggle();
        $(this).find(".arrow-down").toggle();
        $(this).closest(".accordion-parent").find(".accordion-content").toggleClass("accordion-expanded");
    });
}
...
function MobilePageOptions() {
    $(".mobileHeader").addClass("hide").hide();
    $(".mobileHeaderLink").unbind("click").click(function () {
        if($(".mobileHeader").hasClass("hide")){
            $(".mobileHeader").removeClass("hide").show();
        } else {
            $(".mobileHeader").addClass("hide").hide();
        }
    });
...
function tileOptions() {
    $(".tileoption1Link").click(function () {
        var tilePar = $(this).closest(".tileoptionParent");
        tilePar.find(".tileoption").addClass("hide");
        tilePar.find(".tileoption").hide();
        tilePar.find(".tileoption1").toggleClass("hide");
        tilePar.find(".tileoptionLink").removeClass("tileoptionSelected");
        tilePar.find(".tileoption1Link").addClass("tileoptionSelected");
        tilePar.find(".tileoption1").fadeToggle(500);
    });
    $(".tileoption2Link").click(function () {
        var tilePar = $(this).closest(".tileoptionParent");
        tilePar.find(".tileoption").addClass("hide");
        tilePar.find(".tileoption").hide();
        tilePar.find(".tileoption2").toggleClass("hide");
        tilePar.find(".tileoptionLink").removeClass("tileoptionSelected");
        tilePar.find(".tileoption2Link").addClass("tileoptionSelected");
        tilePar.find(".tileoption2").fadeToggle(500);
    });
}
...
function sortText(parent, childSelector, keySelector, order) {
//    $(".loader").show(500);
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data === "Account Created Successfully") {
                CustomAlert("Your Account has been created successfully.");
