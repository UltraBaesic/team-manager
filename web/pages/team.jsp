<%-- 
    Document   : team
    Created on : 01-Oct-2017, 06:22:14
    Author     : Stephen
--%>
...
<html>
    ...
    <body class="light">
        <jsp:include page="../WEB-INF/static_pages/General/header.jsp"></jsp:include>
        <jsp:include page="../WEB-INF/static_pages/General/leftPanel.jsp"></jsp:include>
        <jsp:include page="../WEB-INF/static_pages/General/teamPage.jsp"></jsp:include>
